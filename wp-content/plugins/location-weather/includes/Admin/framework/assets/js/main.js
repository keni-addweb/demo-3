;(function( $, window, document, undefined ) {
  ...
  $.fn.csf_expand_all = function() {
    return this.each( function() {
      $(this).on('click', function( e ) {
        ...
        $('.splwt-lite-section').csf_reload_script();
    ...
    return this.each( function() {
      ...
      if( $fields.length ) {
        ...
        if ( global_depends.length ) {
          $.csf_deps.enable(SPLW.vars.$body, global_ruleset, global_depends);
        }
  ...
  $.fn.csf_field_background = function() {
    return this.each( function() {
      $(this).find('.splwt-lite--background-image').csf_reload_script();
    });
  };
  ...
  $.fn.csf_field_fieldset = function() {
    return this.each( function() {
      $(this).find('.splwt-lite-fieldset-content').csf_reload_script();
    });
  };
    ...
    return this.each( function() {
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_helper  = $parent.children('.splwt-lite-cloneable-helper').csf_clone(true),
            $cloned_title   = $parent.children('.splwt-lite-cloneable-title').csf_clone(),
            $cloned_content = $parent.children('.splwt-lite-cloneable-content').csf_clone(),
  ...
  $.fn.csf_field_repeater = function() {
    return this.each( function() {
      ...
      $wrapper.children('.splwt-lite-repeater-item').children('.splwt-lite-repeater-content').csf_reload_script();
      ...
      $repeater.children('.splwt-lite-repeater-add').on('click', function( e ) {
        ...
        $wrapper.append($cloned_item);
        $cloned_item.children('.splwt-lite-repeater-content').csf_reload_script();
        $wrapper.csf_customizer_refresh();
        $wrapper.csf_customizer_listen({closest: true});
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_content = $parent.children('.splwt-lite-repeater-content').csf_clone(),
            $cloned_helper  = $parent.children('.splwt-lite-repeater-helper').csf_clone(true),
  ...
  $.fn.csf_field_sortable = function() {
    return this.each( function() {
      ...
      $sortable.find('.splwt-lite-sortable-content').csf_reload_script();
        ...
        if ( !flooding ) {
          ...
          if ( $this.hasClass('splwt-lite-save-ajax') ) {
            ...
            window.wp.ajax.post( 'csf_'+ $panel.data('unique') +'_ajax_save', {
              data: $('#splwt-lite-form').serializeJSONCSF()
            })
            .done( function( response ) {
    ...
    return this.each( function() {
      ...
      if ( $form.attr('id') === 'addtag' ) {
        ...
        var $submit = $form.find('#submit'),
            $cloned = $this.find('.splwt-lite-field').csf_clone();
  ...
  $.fn.csf_shortcode = function() {
    ...
    return this.each( function() {
      ...
      $select.on( 'change', function() {
        ...
        if ( sc_key ) {
          ...
          .done( function( response ) {
            ...
            $cloned = $appended.find('.splwt-lite--repeat-shortcode').csf_clone();

            $appended.csf_reload_script();
            $appended.find('.splwt-lite-fields').csf_reload_script();
      ...
      $insert.on('click', function( e ) {
        ...
        var shortcode = '';
        var serialize = $modal.find('.splwt-lite-field:not(.splwt-lite-depend-on)').find(':input:not(.ignore)').serializeObjectCSF();
      ...
      $modal.on('click', '.splwt-lite--repeat-button', function( e ) {
        ...
        $new_clone.find('.splwt-lite-fields').csf_reload_script();
    ...
    return this.each( function() {
      ...
      $this.on({
        mouseenter: function() {
          ...
          offset_left = ( SPLW.vars.is_rtl ) ? ( $this.offset().left + 24 ) : ( $this.offset().left - $tooltip.outerWidth() );
  ...
  $.fn.csf_widgets = function() {
    if ( this.length ) {
      ...
      $(document).on('widget-added widget-updated', function( event, $widget ) {
        $widget.find('.splwt-lite-fields').csf_reload_script();
      });

      $('.widgets-sortables, .control-section-sidebar').on('sortstop', function( event, ui ) {
        ui.item.find('.splwt-lite-fields').csf_reload_script_retry();
      });

      $(document).on('click', '.widget-top', function( event ) {
        $(this).parent().find('.splwt-lite-fields').csf_reload_script();
      });
  ...
  $.fn.csf_nav_menu = function() {
    return this.each( function() {
      ...
      $navmenu.on('click', 'a.item-edit', function() {
        $(this).closest('li.menu-item').find('.splwt-lite-fields').csf_reload_script();
      });
  ...
  $.fn.csf_reload_script_retry = function() {
    return this.each( function() {
      ...
      if ( $this.data('inited') ) {
        $this.children('.splwt-lite-field-wp_editor').csf_field_wp_editor();
      }
  ...
  $.fn.csf_reload_script = function( options ) {
    ...
    return this.each( function() {
      ...
      if ( !$this.data('inited') ) {
        ...
        // Field plugins
        $this.children('.splwt-lite-field-accordion').csf_field_accordion();
        $this.children('.splwt-lite-field-backup').csf_field_backup();
        $this.children('.splwt-lite-field-background').csf_field_background();
        $this.children('.splwt-lite-field-code_editor').csf_field_code_editor();
        $this.children('.splwt-lite-field-date').csf_field_date();
        $this.children('.splwt-lite-field-fieldset').csf_field_fieldset();
        $this.children('.splwt-lite-field-gallery').csf_field_gallery();
        $this.children('.splwt-lite-field-group').csf_field_group();
        $this.children('.splwt-lite-field-icon').csf_field_icon();
        $this.children('.splwt-lite-field-media').csf_field_media();
        $this.children('.splwt-lite-field-map').csf_field_map();
        $this.children('.splwt-lite-field-repeater').csf_field_repeater();
        $this.children('.splwt-lite-field-slider').csf_field_slider();
        $this.children('.splwt-lite-field-sortable').csf_field_sortable();
        $this.children('.splwt-lite-field-sorter').csf_field_sorter();
        $this.children('.splwt-lite-field-spinner').csf_field_spinner();
        $this.children('.splwt-lite-field-switcher').csf_field_switcher();
        $this.children('.splwt-lite-field-tabbed').csf_field_tabbed();
        $this.children('.splwt-lite-field-typography').csf_field_typography();
        $this.children('.splwt-lite-field-upload').csf_field_upload();
        $this.children('.splwt-lite-field-wp_editor').csf_field_wp_editor();

        // Field colors
        $this.children('.splwt-lite-field-border').find('.splwt-lite-color').csf_color();
        $this.children('.splwt-lite-field-background').find('.splwt-lite-color').csf_color();
        $this.children('.splwt-lite-field-color').find('.splwt-lite-color').csf_color();
        $this.children('.splwt-lite-field-color_group').find('.splwt-lite-color').csf_color();
        $this.children('.splwt-lite-field-link_color').find('.splwt-lite-color').csf_color();
        $this.children('.splwt-lite-field-typography').find('.splwt-lite-color').csf_color();

        // Field chosenjs
        $this.children('.splwt-lite-field-select').find('.splwt-lite-chosen').csf_chosen();

        // Field Checkbox
        $this.children('.splwt-lite-field-checkbox').find('.splwt-lite-checkbox').csf_checkbox();

        // Field Siblings
        $this.children('.splwt-lite-field-button_set').find('.splwt-lite-siblings').csf_siblings();
        $this.children('.splwt-lite-field-image_select').find('.splwt-lite-siblings').csf_siblings();
        $this.children('.splwt-lite-field-palette').find('.splwt-lite-siblings').csf_siblings();

        // Help Tooptip
        $this.children('.splwt-lite-field').find('.splwt-lite-help').csf_help();
  ...
  $(document).ready( function() {
    ...
    $('.splwt-lite-save').csf_save();
    $('.splwt-lite-options').csf_options();
    $('.splwt-lite-sticky-header').csf_sticky();
    $('.splwt-lite-nav-options').csf_nav_options();
    $('.splwt-lite-nav-metabox').csf_nav_metabox();
    $('.splwt-lite-taxonomy').csf_taxonomy();
    $('.splwt-lite-page-templates').csf_page_templates();
    $('.splwt-lite-post-formats').csf_post_formats();
    $('.splwt-lite-shortcode').csf_shortcode();
    $('.splwt-lite-search').csf_search();
    $('.splwt-lite-confirm').csf_confirm();
    $('.splwt-lite-expand-all').csf_expand_all();
    $('.splwt-lite-onload').csf_reload_script();
    $('.widget').csf_widgets();
    ...
    /* Copy to clipboard */
    $('button.splw-copy').click(function (e) {
      e.preventDefault()
      splw_copyToClipboard($(this).siblings('span'))
      $(this)
        .find('.splw-tooltip')
        .text('Copied!')
        .css('width', '25%')
