        ...
        echo '<div class="splwt-lite-wrapper'. esc_attr( $show_all ) .'">';
          ...
          echo '<div class="splwt-lite-content">';
            ...
            if ( ! empty( $this->args['show_restore'] ) || ! empty( $this->args['show_reset'] ) ) {
              ...
              echo '<span class="button splwt-lite-button-reset">'. esc_html__( 'Reset', 'splwt-lite' ) .'</span>';
              echo '<span class="button splwt-lite-button-cancel">'. sprintf( '<small>( %s )</small> %s', esc_html__( 'update post', 'splwt-lite' ), esc_html__( 'Cancel', 'splwt-lite' ) ) .'</span>';
              echo '</label>';
              echo '</div>';
