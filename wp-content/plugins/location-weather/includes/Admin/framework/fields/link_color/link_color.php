...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'splwt-lite' ),
        'hover'    => esc_html__( 'Hover', 'splwt-lite' ),
        'active'   => esc_html__( 'Active', 'splwt-lite' ),
        'visited'  => esc_html__( 'Visited', 'splwt-lite' ),
        'focus'    => esc_html__( 'Focus', 'splwt-lite' )
      );
