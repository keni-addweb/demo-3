			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'type'    => 'select',
						'desc'    => __( 'To unlock the gradient, image, and video background settings, <a href="https://shapedplugin.com/plugin/location-weather-pro/" target="_blank"><b>Upgrade To Pro!</b></a>', 'location-weather' ),
