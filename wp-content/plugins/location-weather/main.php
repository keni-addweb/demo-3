 ...
 * Plugin URI:        https://wordpress.org/plugins/location-weather/
 * Author:            ShapedPlugin
...
final class Location_Weather {
	...
	public function add_plugin_action_links_location( $links, $file ) {
		...
		if ( plugin_basename( __FILE__ ) === $file ) {
			...
			$links['go_pro'] = sprintf( '<a target="_blank" href="%1$s" style="color: #35b747; font-weight: 700;">Go Premium!</a>', 'https://shapedplugin.com/plugin/location-weather-pro/' );
